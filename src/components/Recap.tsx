...
const CallLogDashboard = () => {
  const callLogs = [
    ...
    },
    {
      ...
      currentRate: "",
      quotedRate: "86.67",
      text: "Hola, buen d�a. Ya le tengo los precios, s�guese. A ver, d�game. De dos euros una vez por semana estar�a en 86 con 67 d�lares. 86 d�lares, 67 es lo que estar�a pagando. Obviamente es un contrato de tres a�os, �no? El contrato pues s� tiene incremento anual, pero es el m�s bajo en el mercado. Digamos que otras empresas pues cobran... �Cu�nto ser�a el incremento? Quiero saber el porcentaje porque luego despu�s se empieza a subir, sube se alcanza uno. Mire, no tenemos como uno fijo que es lo que creo que ninguna empresa puede tener, llegar a tener, vaya, es conforme al mercado, pero s� es el m�s bajo en el mercado. Solo para el ejemplo, el a�o pasado increment� entre un 6% nada m�s. O sea que es realmente nada comparado con otras empresas que incrementan entre un 8% y un 14% como Republic Services, Waste Management, Waste Connections, �no? El contrato es tres a�os con otra renovaci�n y se le est� entregando a las dos semanas, es en lo que se procesa, b�sicamente. �Y el contrato hay que renovarse? �Tengo que llevar ya marca despu�s de tres a�os para renovarlo o autom�tico? No, es autom�tico. Entonces, si yo quisiera no renovar, �tendr�a que llamar antes de que se vence o qu�? En el primer a�o regularmente es cuando se le comenta a Customer Service de que sabes que no quiere autorrenovar el contrato y entonces ya ah� es cuando se le aplica, �no? La no autorrenovaci�n, b�sicamente. �Cu�nto tiempo despu�s? Perd�n, �cu�nto tiempo antes de los tres a�os tengo que llamar para decir no ya no lo quiero lo que sea pues regularmente lo que yo les recomiendo es que al primer a�o se le diga �sabes qu�? o sea al primer a�o porque ah� es cuando ya sabes realmente si te gust� o no el servicio entonces ya de ah� ya decides sabes que no si le contin�o entonces lo dejo as� como va �no? entonces ser�a pensar�an dos a�os todav�a de espera por el contrato �no? si yo les llamo un mes o dos meses antes de que se vence el contrato, no aplica as�. Pues regularmente son 30 d�as, pero yo siempre les recomiendo que por seguridad m�s que nada, pues, habitar desde el primer a�o, pues, es algo que s� podr�a, que podr�a ayudar los m�s para hacer aplicable esa parte. �Cu�ntas veces que se aplica? Si les va a hablar uno y le dice, no, pues ya en el primer a�o ya luego le van a empezar a incrementar m�s y luego ya saben que no va, que no se va a renovar. M�s bien, yo no creo eso, porque regularmente lo que hace la empresa es preguntar a los clientes si hay algo que no les est� gustando del servicio, �para qu�? Pues para mejorarlo, �no? Es regularmente lo que se hace. No s� otras empresas c�mo funcionan realmente en ese aspecto, pero lo que se hace en esta empresa es as�. Ok, entonces ser�an dos yardas recogiendo cada ocho d�as. Ahora, cuatro yardas recogiendo cada quince, �no tienes precio para eso? No tengo, pero tengo para una semana. Son 122.14. O sea que no tienes recogido. Recogiendo cada 15 tiene que ser cada 8 d�as. As� es, aj�, as� es, aj�. Es correcto. �Y c�mo es que se hace un contrato? Se lo env�a al correo electr�nico. Usted lo lee. En caso de que ya est� listo, pues ya nada m�s me da la firma. Una vez que se firma, yo lo subo a Customer Service. Customer Service empieza con el proceso de la entrega. Se le env�a una welcome letter, que es b�sicamente con las instrucciones del autopago. O sea, ahorita, si usted me lo firm�, yo le aplicar�a parte de los 86.67, le aplico los 70 de cr�dito en caso de que le interese el autopago. Si dice s� al autopago, van a ser 70 d�lares S�, s�. Ok, eso que no es autopago. �Cu�nto es lo que hay que pagar cada mes nom�s para estar seguro? 86,67. Menos los 5 d�lares del autopago a partir del tercer mes ser�an 81,67. S�, bueno, eso s�, no es autopago. 86,67. eso ser�a por el de dos yardas nada m�s, �verdad? As� es, por el de dos yardas. Realmente le voy a decir que est� s�per bien porque regularmente me dan 100 d�lares y ahorita me est�n dando 86 con 67 y me qued� guau. Ok, entonces d�jame, yo le voy a marcar, �por qui�n pregunto cuando yo marque este n�mero? �C�mo le hago para comunicarme con usted? Don Diana, �gusta que le env�e el contrato nom�s para que lo vaya checando? de cualquier manera es sin compromiso voy a comparar precios porque es la primera persona que llamo y la nueva era para precios pero si usted es el mejor pues ah� ya entonces si le digo que me lo mande ya ya lo firmamos. Ah, ok. Bueno, me parece muy bien. La otra pregunta era, de cuatro yardas recogiendo cada semana, �cu�nto me dijo que era? 122.14. 122.14, ok. Ok, d�jame, d�j denme de qu� ma�ana dar otra buscadita y si no, entonces ah� lo voy a, ah, pero, �me van a comunicar con ustedes directo o s�? Este, el n�mero que le estoy hablando es mi n�mero, aj�, igual aqu� me puede contactar, me manda un mensajito o me marque y ya yo le contesto y le explico. Aj�. Ah, Diana. Diana. Diana. Ok. Ok. Muchas gracias. Gracias, buen d�a. Bye bye.",
      publicFilePath:
